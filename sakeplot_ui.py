...
class Ui_SAKEDSP(object):
    def setupUi(self, SAKEDSP):
        ...
        self.gridLayout.addWidget(self.PowerAreaButton, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.picLabel, 0, 0, 9, 1)
        ...
        self.gridLayout.addWidget(self.PSDEdit, 4, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.distButton, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.distEdit, 6, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.labelDist, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelPSDRange, 4, 1, 1, 1)
        ...
        self.labelNormalize = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.labelNormalize.setFont(font)
        self.labelNormalize.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelNormalize.setObjectName("labelNormalize")
        self.gridLayout.addWidget(self.labelNormalize, 3, 1, 1, 1)
        self.normGroup = QtWidgets.QComboBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.normGroup.setFont(font)
        self.normGroup.setObjectName("normGroup")
        self.gridLayout.addWidget(self.normGroup, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBoxNorm, 3, 4, 1, 1)
