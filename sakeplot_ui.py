...
class Ui_SAKEDSP(object):
    def setupUi(self, SAKEDSP):
        ...
        self.gridLayout.addWidget(self.normCol, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.normGroup, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelNormalize, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBoxNorm, 5, 4, 1, 1)
